...
export default function Hero(){
    ...
    return(
        ...
        <div className="flex flex-col items-center ">
            ...
            max-490px:text-[12px] max-490px:max-w-[320px] max-400px:text-[10px] max-400px:max-w-[260px] max-400px:leading-[18px] max-400px:mt-[11px]">From move-in-ready to custom homes,<span className="font-normal text-[24px] leading-[32.78px] max-900px:text-[22px] max-700px:text-[18px] max-700px:leading-[26px]
            max-490px:text-[15px] max-400px:text-[13px]">fresh<span className="font-extrabold">builds</span></span> is the modern way to find + buy a new construction house.</p>
